        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Direccion_Direccion_ClienteId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IndPadre = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IndCambio = table.Column<bool>(type: "bit", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Pedido_Direccion_DireccionId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Estado = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    MarcaEntityId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Producto_Marca_MarcaEntityId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Entrada_Usuario_UsuarioCreacionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UsuarioMenu", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UsuarioMenu_Menu_MenuId",
                        column: x => x.MenuId,
                        principalTable: "Menu",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UsuarioMenu_Usuario_UsuarioId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Entrada_UsuarioCreacionId",
                table: "Entrada",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Producto_MarcaEntityId",
                table: "Producto",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UsuarioMenu_MenuId",
                table: "UsuarioMenu",
                column: "MenuId");

            migrationBuilder.CreateIndex(
                name: "IX_UsuarioMenu_UsuarioId",
                table: "UsuarioMenu",
                column: "UsuarioId");
        }
